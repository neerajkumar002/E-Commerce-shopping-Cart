...
const CartItem = ({ id, title, price, thumbnail, quantity }) => {
  const { decrementQuantity, removeCartProduct, addToCart } = useProductData();
  return (
      ...
      <div className="flex flex-col px-2 w-full">
        ...
        <div className="">
          <div className="flex w-10 justify-between py-1">
            <button
              className="bg-slate-800 rounded-sm text-white px-2 "
            ...
            <button
              className="bg-slate-800 rounded-sm text-white"
